...
const Blog = () => {
    ...
    return (
        <article className="max-w-2xl px-6 py-24 mx-auto space-y-12 dark:bg-gray-100 dark:text-gray-900">
            ...
            {/* tabs */}
            <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden justify-start flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                <Link onClick={() => setTabIndex(0)} to=''
                ...
                <Link onClick={() => setTabIndex(1)} to={`author`}
                    className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2
                ...
                <div onClick={() => handleBookmark(blog)} className=" p-3 rounded-full ">
