...
const Author = () => {
    ...
    const { name, profile_image, github_username, username, twitter_username, website_url } = blog.user;
    return (
            ...
            <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                ...
                <div className="flex justify-center pt-2 space-x-4 align-center">
                    ...
                    <a rel="noopener noreferrer" target="_blank"
                        href={website_url} aria-label="Dribble" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
